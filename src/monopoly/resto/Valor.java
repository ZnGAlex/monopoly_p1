...
public class Valor {
    ...
    public static final int POSICION_CASILLA_IMPUESTO = 4;
    public static final int POSICION_CASILLA_TRANSPORTE = 5;
    ...
    public static final int POSICION_CASILLA_CARCLE = 10;
