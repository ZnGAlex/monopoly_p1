...
public class Valor {
    ...
    public static final int FORTUNA_INICIAL = 50; // (COSTE_GRUPO_NEGRO + COSTE_GRUPO_CYAN + COSTE_GRUPO_ROSA + COSTE_GRUPO_NARANJA + COSTE_GRUPO_ROJO + COSTE_GRUPO_AMARILLO + COSTE_GRUPO_VERDE + COSTE_GRUPO_AZUL) / 3;
